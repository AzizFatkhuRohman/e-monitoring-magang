            ...
            <form action="{{ route('profile.mentor_vokasi.leader_post') }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="leader" placeholder="Masukan Nama Leader"
                            value="{{ old('leader') }}" required autofocus>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        ...
                                        @if ($data->isEmpty())
                                        <div class="col-md-8">
                                            <p style="color: red"> {{ isset($data->first()->leader) ? 'Bpk/Ibu '.
                                                $data->first()->leader : 'Input Leader Untuk Mengakses' }} <button
                                                    type="button" data-bs-toggle="modal" data-bs-target="#tambahLeader"
                                                    class="btn btn-primary btn-xs rounded">Tambah</button></p>
                                        </div>
                                        @else
                                        <div class="col-md-8">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama"
                                    value="{{ $data->first()->user->nama }}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="inputName2" class="form-label">No Handphone :</label>
                                <input type="number" class="form-control" name="no_telp" placeholder="Contact"
                                    value="{{ $data->first()->user->no_telp }}">
                            </div>
                            <div class="col-md-6">
                                <label for="inputEmail" class="form-label">Email :</label>
                                <input type="email" class="form-control" name="email" placeholder="Email"
                                    value="{{ $data->first()->user->email }}" disabled>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="nomor_induk" placeholder="Nomor Induk"
                                    value="{{ $data->first()->user->nomor_induk }}" readonly>
                            </div>
                            <div class="col-md-12">
                                <label for="inputEmail" class="form-label">Leader : </label>
                                <input type="text" class="form-control" name="leader" placeholder="leader"
                                    value="{{ $data->first()->leader }}">
                            </div>
                            <div class="col-md-12">
                                <label for="inputEmail" class="form-label">Alamat</label>
                                <textarea class="form-control" name="alamat"
                                    rows="4">{{ $data->first()->user->alamat }}</textarea>
                            </div>
                            <div class="col-12">
