            ...
            <tbody>
                ...
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#ext{{$item->id}}">
                                    <i class="ti ti-plus"></i>
                                </button>
                    
                                <!-- Modal -->
                                <div class="modal fade" id="ext{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{url('admin/section/'.$item->id)}}" method="post">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="exampleFormControlInput1" class="form-label">Section</label>
                                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                                            name="section" value="{{$item->section}}">
                                                    </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-primary">Simpan</button>
                                ...
                                @csrf
                            @method('delete')
                            <button class="btn btn-danger btn-sm" style="margin-left: 2px" type="button" onclick="ClickSec()"><i class="ti ti-trash"></i></button>
                            </form>
                            </div>
                        </td>
                    </tr>
