                        ...
                        <div class="modal-body">
                            <form action="" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <label for="exampleFormControlInput1" class="form-label">Nama Departement
                                            Head</label>
            ...
            <tbody>
                ...
                <td>
                    <div class="d-flex">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="ex{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{url('admin/section-head/'.$item->id)}}" method="post">
                                            @csrf
                                            @method('put')
                                            <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        id="exampleFormControlInput1" name="nama_section_head"
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example"
                                                        name="section">
                                                        <option value="{{$item->section_id}}">{{$item->section->section}}</option>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example"
                                                        ...
                                                        <option value="{{$d->id}}">{{$d->nama_departement_head}} -
                        ...
                        @csrf
                        @method('delete')
                        <button class="btn btn-danger btn-sm" type="button" onclick="clickSecHead()" style="margin-left: 2px">
