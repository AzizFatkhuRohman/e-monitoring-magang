                        ...
                        <div class="modal-body">
                            <form action="" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <label for="exampleFormControlInput1" class="form-label">Section Head</label>
        ...
        <table class="table table-hover table-bordered border-primary" id="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$item->sectionHead->section->section}} - {{$item->sectionHead->nama_section_head}}</td>
                            ...
                            <div class="modal fade" id="modal{{$item->id}}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{url('admin/grup-leader/'.$item->id)}}" method="post">
                                                @csrf
                                                @method('put')
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            id="exampleFormControlInput1" name="nama_grup_leader"
