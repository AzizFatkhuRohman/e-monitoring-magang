                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            id="exampleFormControlInput1" name="nama_departement_head"
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <select class="form-select" aria-label="Default select example"
                                                            name="departement">
                                                            <option value="{{$item->departement_id}}">{{$item->departement->departement}}</option>
                                                            @foreach ($departement as $col)
                                                            <option value="{{$col->id}}">{{$col->departement}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-6">
                            ...
                            <form action="{{url('/admin/departement-head/'.$item->id)}}" method="post" id="departement_head">
                                @csrf
                                @method('delete')
                                <button type="button" class="btn btn-danger btn-sm" onclick="ClickdHead()"
                                    style="margin-left: 2px"><i class="ti ti-trash"></i></button>
                            </form>
                        </div>
                    </td>
                </tr>
